  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{ url('logo') }}" class="sl-menu-link @yield('logo')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-crosshairs tx-22"></i>
            <span class="menu-item-label">Site Logo</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ url('add/category') }}" class="nav-link">Add Category</a></li>
          <li class="nav-item"><a href="{{ url('category/list') }}" class="nav-link">Category List</a></li>
        </ul>

        <a href="" class="sl-menu-link @yield('slider')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-area-chart tx-20"></i>
            <span class="menu-item-label">Slider Manage</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ url('add/slider') }}" class="nav-link">Add Slider</a></li>
          <li class="nav-item"><a href="{{ url('slider/list') }}" class="nav-link">Slider List</a></li>
        </ul>

        <a href="{{ url('contact/message/show') }}" class="sl-menu-link @yield('contact')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-envelope-o tx-20"></i>
            <span class="menu-item-label">Contact Messages</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->

        <a href="" class="sl-menu-link @yield('cupon')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-magic tx-20"></i>
            <span class="menu-item-label">Cupon Menage</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ url('cupon/add') }}" class="nav-link">Add Cupon</a></li>
          <li class="nav-item"><a href="{{ url('cupon/list') }}" class="nav-link">Cupon List</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{ url('product/list') }}" class="nav-link">Product List</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ url('add/testimonial') }}" class="nav-link">Add Testimonial</a></li>
          <li class="nav-item"><a href="{{ url('testimonial/list') }}" class="nav-link">Testimonial List</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ url('blog/add') }}" class="nav-link">Add Blog Post</a></li>
          <li class="nav-item"><a href="{{ url('blog/list') }}" class="nav-link">Blog Post List</a></li>
        </ul>

        <a href="{{ url('faq/list') }}" class="sl-menu-link @yield('faq')">
          <div class="sl-menu-item">
            <i class="menu-item-icon fa fa-globe tx-20"></i>
            <span class="menu-item-label">FAQ Manage</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->

        <a href="{{ url('social/media') }}" class="sl-menu-link @yield('social_media')">
          <div class="sl-menu-item">
            <i class="menu-item-icon fa fa-globe tx-20"></i>
        ...
        <a href="{{ url('subscribe') }}" class="sl-menu-link @yield('subscribe')">
          <div class="sl-menu-item">
