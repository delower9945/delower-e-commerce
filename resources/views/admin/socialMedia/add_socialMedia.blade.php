...
<div class="sl-mainpanel">
  <nav class="breadcrumb sl-breadcrumb">
    ...
    <span class="breadcrumb-item active">Social Media Add</span>
  </nav>
    ...
    <div class="row row-sm">
      ...
      <div class="col-6 m-auto">
        <div class="card mt-3">
          ...
          <div class="card-body">
            <form action="{{ url('social/media/post') }}" method="post">
              @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" name="social_media_link" class="form-control" id="name">
