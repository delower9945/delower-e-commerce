  ...
  <body>
    ...
    <div class="d-flex align-items-center justify-content-center bg-sl-primary ht-100v">
      ...
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
        <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">E-Commerce Web Site <span class="tx-info tx-normal"></span></div>
        <div class="tx-center mg-b-60">E-Commerce Web Site Login page</div>
        ...
        <div class="mg-t-60 tx-center">Not yet a member? <a href="{{ url('customer/register') }}" class="tx-info">Sign Up</a></div>
      </form>
      </div><!-- login-wrapper -->
    </div><!-- d-flex -->
